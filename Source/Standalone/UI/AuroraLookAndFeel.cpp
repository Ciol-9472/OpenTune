                                        ...
                                        const juce::Drawable* icon, const juce::Colour* textColour)
{
    ...
    juce::Colour textCol = (textColour != nullptr ? *textColour : juce::Colour(Aurora::Colors::TextPrimary));
    ...
    if (isHighlighted && isActive)
    {
        ...
        g.fillRect(area);
        g.setColour(juce::Colour(Aurora::Colors::Cyan));
        g.fillRect(area.reduced(2, 0).removeFromLeft(3));
        textCol = juce::Colour(Aurora::Colors::TextPrimary);
    }
    else
    {
        textCol = (textColour != nullptr ? *textColour : juce::Colour(Aurora::Colors::TextSecondary));
